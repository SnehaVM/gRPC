...
class WalletServicer(wallet_pb2.WalletServicer):
    ...
    def __init__(self):
        ...
        self.__class__.fkey = Fernet(key)
    ...
    def encrypt(self, request, context):
        ...
        '''
        # TODO
        token = self.__class__.fkey.encrypt(bytes(request.card))
    ...
    def decrypt(self, request, context):
        ...
        '''
        # TODO
        card = self.__class__.fkey.decrypt(bytes(request.token))
        return wallet_pb2.CardDecryptResponse(card_in_plain_text=card)
